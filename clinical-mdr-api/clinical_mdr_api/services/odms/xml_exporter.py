        ...
        def create_odm_item_def():
            ...
            for item in self.odm_data_extractor.odm_items:
                ...
                for activity_instance in item.activity_instances:
                    _key = (
                        activity_instance.activity_instance_name or "",
                        activity_instance.activity_instance_adam_param_code,
                        activity_instance.activity_instance_topic_code,
                    )
                    ...
                    activity_instances.append(
                        OsbActivityInstance(
                            _string=activity_instance.activity_instance_name or "",
                            adam_code=Attribute(
                                "osb:adamCode",
                                activity_instance.activity_instance_adam_param_code,
                            ),
