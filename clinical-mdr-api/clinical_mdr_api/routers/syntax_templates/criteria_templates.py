...
def get_parameters(
    ...
    return Service().get_parameters(uid=criteria_template_uid, study_uid=study_uid)
...
@router.get(
    "/{criteria_template_uid}/affected-studies",
    dependencies=[security, rbac.LIBRARY_READ],
    summary="Returns a list of specific affected clinical studies for a criteria template.",
...
def get_affected_studies(
    ...
    return get_affected_studies_for_template(uid=criteria_template_uid)
