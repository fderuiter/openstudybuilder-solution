...
def get_parameters(
    ...
    return Service().get_parameters(uid=endpoint_template_uid, study_uid=study_uid)
...
@router.get(
    "/{endpoint_template_uid}/affected-studies",
    dependencies=[security, rbac.LIBRARY_READ],
    summary="Returns a list of specific affected clinical studies for an endpoint template.",
...
def get_affected_studies(
    ...
    return get_affected_studies_for_template(uid=endpoint_template_uid)
