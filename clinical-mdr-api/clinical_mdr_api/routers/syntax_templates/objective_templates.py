...
@router.get(
    "/{objective_template_uid}/affected-studies",
    dependencies=[security, rbac.LIBRARY_READ],
    summary="Returns a list of specific affected clinical studies for an objective template.",
...
def get_affected_studies(
    ...
    return get_affected_studies_for_template(uid=objective_template_uid)
