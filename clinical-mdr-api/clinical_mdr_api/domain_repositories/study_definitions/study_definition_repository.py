...
"""
    ...
    def get_study_selection_labels_for_study(self, study_uid: str) -> list[str]:
        ...
        """
        query = """
        MATCH (sr:StudyRoot {uid: $study_uid})-[:LATEST]->(sv:StudyValue)-[rel:HAS_STUDY_VISIT|HAS_STUDY_ACTIVITY|HAS_STUDY_ACTIVITY_INSTANCE|HAS_STUDY_ACTIVITY_SCHEDULE|HAS_STUDY_ARM|HAS_STUDY_COHORT|HAS_STUDY_BRANCH_ARM|HAS_STUDY_EPOCH|HAS_STUDY_ELEMENT|HAS_STUDY_ENDPOINT|HAS_STUDY_CRITERIA|HAS_STUDY_OBJECTIVE|HAS_STUDY_DATA_SUPPLIER|HAS_STUDY_COMPOUND_DOSING|HAS_STUDY_DISEASE_MILESTONE|HAS_STUDY_FOOTNOTE|HAS_STUDY_COMPOUND|HAS_STUDY_DEFINITION_DOCUMENT|HAS_STUDY_STANDARD_VERSION|HAS_COMPLETENESS_TAG|HAS_PROJECT_FIELD|HAS_TEXT_FIELD|HAS_TIME_FIELD|HAS_BOOLEAN_FIELD|HAS_ARRAY_FIELD]->(ss:StudySelection)
    ...
    def get_study_selection_statistics_for_labels(
        ...
        OPTIONAL MATCH (sr:StudyRoot {uid: $study_uid})-[:LATEST]->(sv:StudyValue)-[rel:HAS_STUDY_VISIT|HAS_STUDY_ACTIVITY|HAS_STUDY_ACTIVITY_INSTANCE|HAS_STUDY_ACTIVITY_SCHEDULE|HAS_STUDY_ARM|HAS_STUDY_COHORT|HAS_STUDY_BRANCH_ARM|HAS_STUDY_EPOCH|HAS_STUDY_ELEMENT|HAS_STUDY_ENDPOINT|HAS_STUDY_CRITERIA|HAS_STUDY_OBJECTIVE|HAS_STUDY_DATA_SUPPLIER|HAS_STUDY_COMPOUND_DOSING|HAS_STUDY_DISEASE_MILESTONE|HAS_STUDY_FOOTNOTE|HAS_STUDY_COMPOUND|HAS_STUDY_DEFINITION_DOCUMENT|HAS_STUDY_STANDARD_VERSION|HAS_COMPLETENESS_TAG|HAS_PROJECT_FIELD|HAS_TEXT_FIELD|HAS_TIME_FIELD|HAS_BOOLEAN_FIELD|HAS_ARRAY_FIELD]->(ss:StudySelection)
        WHERE type(rel) <> 'HAS_PROTOCOL_SOA_CELL' AND type(rel) <> 'HAS_PROTOCOL_SOA_FOOTNOTE'
...
MATCH (sr_target:StudyRoot)-[:LATEST]->(sv_target:StudyValue)-[relationship:HAS_STUDY_VISIT|HAS_STUDY_ACTIVITY|HAS_STUDY_ACTIVITY_INSTANCE|HAS_STUDY_ACTIVITY_SCHEDULE|HAS_STUDY_ARM|HAS_STUDY_COHORT|HAS_STUDY_BRANCH_ARM|HAS_STUDY_EPOCH|HAS_STUDY_ELEMENT|HAS_STUDY_ENDPOINT|HAS_STUDY_CRITERIA|HAS_STUDY_OBJECTIVE|HAS_STUDY_DATA_SUPPLIER|HAS_STUDY_COMPOUND_DOSING|HAS_STUDY_DISEASE_MILESTONE|HAS_STUDY_FOOTNOTE|HAS_STUDY_COMPOUND|HAS_STUDY_DEFINITION_DOCUMENT|HAS_STUDY_STANDARD_VERSION|HAS_COMPLETENESS_TAG|HAS_PROJECT_FIELD|HAS_TEXT_FIELD|HAS_TIME_FIELD|HAS_BOOLEAN_FIELD|HAS_ARRAY_FIELD]-(selection_target:StudySelection)
