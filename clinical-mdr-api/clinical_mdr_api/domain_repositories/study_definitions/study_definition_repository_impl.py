...
class StudyDefinitionRepositoryImpl(StudyDefinitionRepository, RepositoryImpl):
    ...
    def _study_metadata_snapshot_from_cypher_res(
        ...
        snapshot_dict = {
            ...
            "parent_template_uid": metadata_section.get("parent_template_uid"),
            "parent_template_version": metadata_section.get("parent_template_version"),
            "sync_status": metadata_section.get("sync_status"),
    ...
    def _study_value_from_study_metadata_snapshot(
        ...
        value = StudyValue(
            ...
            parent_template_uid=metadata_snapshot.parent_template_uid,
            parent_template_version=metadata_snapshot.parent_template_version,
            sync_status=metadata_snapshot.sync_status,
        )
        ...
        alias_clause = """
                    ...
                    WITH *,
                        ...
                        CASE WHEN ldr.end_date IS NULL THEN 'DRAFT' ELSE 'LOCKED' END as study_status,
                        {
                            ...
                            parent_template_uid: sv.parent_template_uid,
                            parent_template_version: sv.parent_template_version,
                        ...
                        CASE WHEN has_latest_locked THEN
                        {
                            locked_metadata_array: [
                                locked_version IN collect({
                                    ...
                                    parent_template_uid: svlh.parent_template_uid,
                                    parent_template_version: svlh.parent_template_version,
                                    sync_status: svlh.sync_status,
                        ...
                        CASE WHEN has_latest_released AND lrr.end_date IS NULL THEN
                        {
                            ...
                            parent_template_uid: svr.parent_template_uid,
                            parent_template_version: svr.parent_template_version,
                            sync_status: svr.sync_status,
                        ...
                        CASE WHEN has_latest_draft THEN
                        {
                            ...
                            parent_template_uid: sdr.parent_template_uid,
                            parent_template_version: sdr.parent_template_version,
                            sync_status: sdr.sync_status,
